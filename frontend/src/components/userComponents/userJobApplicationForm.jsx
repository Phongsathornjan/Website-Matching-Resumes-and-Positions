...
const userJobApplicationForm = () => {
  ...
  useEffect(() => {
    if (jobDetail.length != 0) {
      setIsApplicantExists(
        jobDetail.applicants.some((applicant) => applicant.userId === id_User)
      );
    }
  }, [jobDetail]);
            ...
            <div className="container" style={Fade}>
              <section className="mb-5 w-75">
                ...
                <div className="card p-3 mb-3 mt-3">
                  <p>
                    <strong>{jobDetail.companyName}</strong>
                  </p>
              ...
              <section className="mb-5 w-75">
                ...
                <div className="card mt-3 p-4">
                  ...
                  >
                    <p className="mb-1">
                      โพสต์เมื่อ :{" "}
                      {moment(Number(jobDetail.time_stamp)).format(
                        "DD-MM-YYYY"
                      )}
                    </p>
                    {isApplicantExists ? (
